...
import GitHub from "../SvgIcon/GitHubSvgIcon";
import Figma from "../SvgIcon/FigmaSvhIcon";
const Hero = () => {
  return (
    <>
      {/* <Hero Section  */}
      <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-7xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
